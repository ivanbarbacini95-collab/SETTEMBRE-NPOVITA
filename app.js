...
function openChartDialog() {
  ...
  const section = $('chartPreviewSection');
...
function applyTheme(theme, notify = false) {
  ...
  if ($('tradingViewHost')) requestAnimationFrame(renderTradingViewChart);
...
function bindEvents() {
  ...
  $('chartMenuButton').addEventListener('click', openChartDialog);
  document.querySelectorAll('[data-chart-style]').forEach((button) => {
