...
function renderPulseView() {
  ...
  const pnlVisual = pulseAdaptiveVisual(dailyPnl, pnlBand, 'pnl');
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.54').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.54 — Pulse View uses Daily P/L in currency instead of Holdings. PRICE and P/L keep independent visual scales.
