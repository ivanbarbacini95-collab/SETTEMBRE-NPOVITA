...
function renderPortfolio() {
  ...
  $('aprNetwork').textContent = state.networkApr > 0 ? `${state.networkApr.toFixed(3)}%` : '—';
  $('aprCommission').textContent = state.personalApr > 0 ? `${Math.max(0, state.networkApr - state.personalApr).toFixed(3)} p.p.` : '—';
  $('aprNet').textContent = state.personalApr > 0 ? `${state.personalApr.toFixed(3)}%` : '—';
